var my_topics_list = (function () {

var exports = {};

var my_topics_open = false;

/*
 This module manages the "My Topics" section in the upper
 left corner of the app.
 */

function get_filter_li() {
    return $(".top_left_my_topics");
}
...
function set_pm_conversation_count(user_ids_string, count) {
    var pm_li = my_topics_list.get_li_for_user_ids_string(user_ids_string);
...
exports._build_private_messages_list = function (active_conversation) {
    ...
    console.dir(my_topics);

    _.each(my_topics, function (topic) {
        var user_ids_string = topic.user_ids_string;
...
exports.rebuild_recent = function (active_conversation) {
    ...
    if (my_topics_open) {
        var rendered_pm_list = exports._build_private_messages_list(
            active_conversation);
        ui.get_content_element($("#my-topics-container")).html(rendered_pm_list);
    }
...
if (typeof module !== 'undefined') {
    module.exports = my_topics_list;
}

window.my_topics_list = my_topics_list;
